...
- **GCP VM**: Must be running 24/7 for MQTT broker
- **Supabase**: Managed cloud service (always available)
- **Bridge Service**: Runs as systemd service on GCP VM
...
```bash
# On GCP VM, check if MQTT is listening
sudo ss -tlnp | grep 1883

# Test MQTT locally
mosquitto_sub -h localhost -t "petfeeder/#" -u bridge_user -P password -v
```
...
3. Confirm bridge service is running: `sudo systemctl status mqtt-bridge`
...
For more troubleshooting steps, see [SETUP.md#testing--troubleshooting](SETUP.md#7-testing--troubleshooting).
...
This project is part of the CPC357 course curriculum. For educational purposes.
...
- Issues: [GitHub Issues](https://github.com/your-username/cpc357-project/issues)

---

<div align="center">

**Made with care for stray animals**
